...
config :series_tracker_api, SeriesTrackerApiWeb.Endpoint,
  ...
  url: [host: "localhost"],
  render_errors: [
    formats: [json: SeriesTrackerApiWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: SeriesTrackerApi.PubSub,
...
config :series_tracker_api, SeriesTrackerApi.Mailer, adapter: Swoosh.Adapters.Local
